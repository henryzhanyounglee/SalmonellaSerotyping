...
FPili.to_csv("MeanFPili.csv")
FinalAllWork = pd.DataFrame(FinalAllWork, columns = ["Abundance", "PiliGene", "CorrectFiles", "AverageSenSpe"]) 
FinalAllWork.to_csv("MeanFinalAllWorkPili.csv")
SenSpe = pd.DataFrame( TopSen , TopSpe)
SenSpe.to_csv("SalPiliMeanTopSenSpeOnebyOne.csv")